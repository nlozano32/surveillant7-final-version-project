...
app.config(function($routeProvider) {
    ...
    .when("/daily_period_standard", {
        templateUrl : "app/modules/setting/views/form_daily_periods.html"
    })
    ...
    .when("/output", {
        templateUrl : "app/modules/setting/views/form_output.html"
    })
    .when("/sensors", {
    ...
    .when("/global_limit", {
        templateUrl : "app/modules/limits/views/form_global_limit.html"
    });
});
